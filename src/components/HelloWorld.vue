...
export default {
  ...
  data: () => ({
    ...
    twitterLink:
      "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=bXhNTGkxVnIwYTRlSnFiS3plYTA6MTpjaQ&redirect_uri=http://127.0.0.1.com&scope=tweet.read%20users.read%20follows.read%20follows.write&state=twitter&code_challenge=challenge&code_challenge_method=plain",
